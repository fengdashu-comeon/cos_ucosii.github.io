...
#define  CPU_BIT_BAND_SRAM_REG_LO       0x20000000  //sram位带访问最高
#define  CPU_BIT_BAND_SRAM_REG_HI       0x200FFFFF //sramw位带方位最高
...
void  CPU_IntSrcDis (CPU_INT08U  pos)
{
    ...
    switch (pos) {
        ...
        case CPU_INT_USAGEFAULT:                                /* Usage fault.                                         */
             CPU_CRITICAL_ENTER();
             CPU_REG_NVIC_SHCSR &= ~CPU_REG_NVIC_SHCSR_USGFAULTENA; //【注释】内核寄存器需要保护
             CPU_CRITICAL_EXIT();
             break;
